export const enIE = {
  ...
  address: '37 Wellington Place, Dublin 4, D04 A8N0, Ireland',
  
  meta: {
    siteTitle: 'SEVESO & ATEX Process Safety Consultant Dublin | Sabit Burak Cebeci',
    siteDescription: 'Expert SEVESO consultancy & ATEX compliance for pharmaceutical and chemical industries in Ireland. 11+ years experience. Based in Dublin.',
    keywords: 'SEVESO consultant Ireland, ATEX compliance Dublin, process safety consultant Ireland, COMAH regulations'
  },
    ...
    items: [
      ...
      },
      {
        ...
        features: [
          ...
          'ATEX Site Audits & Inspections',
          'Explosive Atmosphere Risk Assessment',
          'EU Directive 2014/34/EU Compliance'
        ]
      },
      {
        ...
        features: [
          ...
          'External Emergency Planning Support',
  ...
  certifications: {
    ...
    subtitle: 'Qualified and Accredited',
    items: [
      'Technical Report Writing - Engineers Ireland (2024)',
      'DNV SA-01 Consequence Modelling Software (2024)',
    ...
    education: [
      "Master's Degree - Occupational Health & Safety (Thesis), 2018-2020",
      "Master's Degree - Occupational Health & Safety (Non-Thesis), 2016-2017",
